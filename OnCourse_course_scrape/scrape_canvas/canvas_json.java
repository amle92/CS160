...
public class canvas_json {
	...
	private static int jsonRemaining = 1;
	public ArrayList<String> crsLinks = new ArrayList<String>();
	public ArrayList<String> shortcrsDes = new ArrayList<String>();
	public ArrayList<String> university = new ArrayList<String>();
	//public ArrayList<String> crsCategory = new ArrayList<String>();
	public ArrayList<String> crsImg = new ArrayList<String>();
	...
	public void parseJSON(JSONObject tempJSON) {
		...
		for(int i = 0; i < courses.length(); i++) {
			...
			shortcrsDes.add(crs.getString("teaser"));
			university.add(crs.getJSONObject("logo").getString("label"));
			//crsCategory.add(""); //couldn't find any meaningful category
			crsImg.add(crs.getString("image"));
			
		}
	}
	public ArrayList getcrsLinks(){
		return crsLinks;
	}
