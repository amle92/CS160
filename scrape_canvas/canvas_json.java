...
public class canvas_json {
    ...
    public ArrayList<String> parseJSON(JSONObject tempJSON) throws JSONException
    {
        ...
        for(int i = 0; i < courses.length(); i++) {
           ...
           // System.out.println("site: " + crs.getString("url"));
            ...
            links.add(crs.getString("url"));
        }
        return links;
    }

    public void getCourseInfo() throws JSONException
    {
        int count = 0;
        do {
           ...
           // System.out.println("Response Code : " + responseCode);
            ...
            ArrayList<String> crsLinks = parseJSON(jsonOBJ);
            currentPageNum++;
            for (String e: crsLinks){
